...
pub const FRAMEBUFFER: *[16320]u8 = @intToPtr(*[16320]u8, undefined);
...
pub extern fn map(x: i32, y: i32, w: i32, h: i32, sx: i32, sy: i32, colorkey: i32, scale: i32, remap: i32) void;
...
pub extern fn spr(id: i32, x: i32, y: i32, colorkey: i32, scale: i32, flip: i32, rotate: i32, w: i32, h: i32) void;
...
pub extern fn textri(x1: i32, y1: i32, x2: i32, y2: i32, x3: i32, y3: i32, u1: i32, v1: i32, u2: i32, v2: i32, u3: i32, v3: i32, use_map: bool, transcolor: i32) void;
...
pub extern fn print(text: [*]u8, x: i32, y: i32, color: i32, fixed: bool, scale: i32, smallfont: bool) i32;
//  font text, x, y, [transcolor], [char width], [char height], [fixed=false], [scale=1] -> text width
pub extern fn font(text: [*]u8, x: u32, y: i32, transcolor: i32, char_width: i32, char_height: i32, fixed: bool, scale: i32) i32;
